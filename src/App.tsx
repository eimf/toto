...
import carlosPic from "./assets/carlos-pic.png";
    ...
    return (
        <div className="bg-gradient-to-br from-[#496270] via-[#9CABDB] to-[#BB9991] min-h-screen">
            ...
            <section
                ...
                style={{
                    opacity: heroOpacity,
                    transform: `scale(${heroScale}) translateY(${
                        scrollY * 0.3
                    }px)`,
                }}
            >
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start mb-8 text-white/90">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a
                                    ...
                                    className="hover:text-[#BB9991] transition-colors cursor-pointer"
                                >
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-xl">
                            ...
                            <p className="text-white/90 leading-relaxed text-lg">
                                Systems engineer with a specialization in
                                quality and continuous improvement, complemented
                                by a master's degree in Data Science. Proven
                                expertise in process analysis, data
                                visualization, and advanced analytics using
                                tools like Power BI, SQL, Python, and R. Strong
                                background in project management, quality
                                assurance, and driving operational excellence
            ...
            <div className="bg-white/95 backdrop-blur-sm">
                ...
                >
                    <h2 className="text-4xl font-bold text-[#496270] mb-12 text-center">
                        ...
                        <div className="space-y-12">
                            <div className="relative pl-20 group">
                                ...
                                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-[#9CABDB]/20">
                                    <h3 className="text-2xl font-bold text-[#496270] mb-2">
                                        Data Analyst | Strategic Business
                                        Analyst
                                    </h3>
                                    <p className="text-[#BB9991] font-semibold mb-1">
                                    ...
                                    <ul className="space-y-2 text-gray-700">
                                        <li className="flex gap-2">
                                            <span className="text-[#9CABDB] font-bold">
                                                •
                                            </span>{" "}
                                            Designed and implemented interactive
                                            dashboards in Power BI for strategic
                                            decision-making
                                        </li>
                                        <li className="flex gap-2">
                                            <span className="text-[#9CABDB] font-bold">
                                ...
                                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-[#9CABDB]/20">
                                    ...
                                    <ul className="space-y-2 text-gray-700">
                                        <li className="flex gap-2">
                                            ...
                                            Led Lean Six Sigma initiatives to
                                        ...
                                        <li className="flex gap-2">
                                            ...
                                            Reduced defect rates by 25% through
                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg border-l-4 border-[#9CABDB] hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="text-gray-700">
                                Specialization: Quality and Continuous
                                Improvement
                            </p>
                        </div>
                    </div>
                ...
                <section
                    ref={skillsRef}
                    className="container mx-auto px-6 py-20 bg-gradient-to-b from-[#496270]/5 to-transparent"
                >
                    <h2 className="text-4xl font-bold text-[#496270] mb-12 text-center">
                        Technical Skills
                    </h2>
                        ...
                        {[
                            ...
                            >
                                <div className="flex justify-between mb-3">
                                    <span className="font-semibold text-[#496270]">
                                        {skill.name}
                                    </span>
                                    <span className="font-bold text-[#BB9991]">
                                        {skill.level}%
                                    </span>
                                </div>
                    ...
                    <div className="max-w-2xl mx-auto space-y-6">
                        <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-[#BB9991]">
                            <div className="flex justify-between items-center">
                                <span className="text-2xl font-bold text-[#496270]">
                                    Spanish
                                </span>
                                <span className="text-lg text-[#BB9991] font-semibold">
                                    Native
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl p-10 shadow-xl">
                        <ul className="space-y-4 text-gray-700">
                            <li className="flex gap-3 items-start">
                                <span className="text-[#BB9991] font-bold text-xl">
                                    •
                                </span>
                                <span className="flex-1">
                                    Advanced expertise in data analysis,
                                    visualization, and business intelligence
                                    tools
                                </span>
                            </li>
                            <li className="flex gap-3 items-start">
                                <span className="text-[#9CABDB] font-bold text-xl">
                                    •
                                </span>
                                <span className="flex-1">
                                    Proven track record in Lean Six Sigma
                                    methodologies and continuous improvement
                                    initiatives
                                </span>
                            </li>
                            <li className="flex gap-3 items-start">
                                <span className="text-[#496270] font-bold text-xl">
                                    •
                                </span>
                                <span className="flex-1">
                                    Strong analytical mindset with ability to
                                    translate complex data into actionable
                                    insights
                                </span>
                            </li>
                            <li className="flex gap-3 items-start">
                            ...
                            <li className="flex gap-3 items-start">
                                ...
                                <span className="flex-1">
                                    Demonstrated ability to drive process
                    ...
                    <div className="container mx-auto px-6">
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <a
                                    href="mailto:Carlos2007056@gmail.com?subject=Contact%20from%20Portfolio&body=Hello%20Carlos%2C%0A%0A"
                                ...
                                <a
                                    href="/documents/Carlos%20Ortega%20CV.docx"
                                    className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full transition-all duration-300 cursor-pointer hover:scale-105 backdrop-blur-sm"
                                    download="Carlos Ortega CV.docx"
                                >
                            ...
                            <div className="flex gap-6 mt-4">
                                <a
                                    href="https://www.linkedin.com/in/carlos-ortega-1b210a61/"
                                    target="_blank"
                            ...
                            <p className="text-white/70 text-center mt-8">
                                © {new Date().getFullYear()} Carlos Alejandro
                                Ortega Arceo. All rights reserved.
                            </p>
                        </div>
                    </div>
                </footer>
